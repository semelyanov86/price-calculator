...
class MainController extends Controller
{
    ...
    public function show(UserData $data)
    {
        ...
        $ownCellulars = collect([]);
        for ($i = 1; $i <= $lines; $i++) {
            $cellularsQuery = ScanDataCellular::select(array('package_change_price', 'package_gb', 'package_min_lines', 'package_minutes', 'package_month_price', 'package_name', 'package_sim_connection_price', 'package_sim_price', 'package_sms', 'id', 'provider_name'))->filtering($filters, $i);
        ...
        for ($i = 1; $i <= $lines; $i++) {
            $ownCellularsQuery = ScanDataCellular::select(array('package_change_price', 'package_gb', 'package_min_lines', 'package_minutes', 'package_month_price', 'package_name', 'package_sim_connection_price', 'package_sim_price', 'package_sms', 'id', 'provider_name'))->filtering($filters, $i);
