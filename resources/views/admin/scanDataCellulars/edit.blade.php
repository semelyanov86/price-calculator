        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.scan-data-cellulars.update", [$scanDataCellular->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('html_changed') ? 'is-invalid' : '' }}" name="html_changed" id="html_changed">{{ old('html_changed', $scanDataCellular->html_changed) }}</textarea>
