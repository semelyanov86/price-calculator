    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.scan-data-cellulars.update", [$scanDataCellular->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('other_details') ? 'is-invalid' : '' }}" name="other_details" id="other_details">{{ old('other_details', $scanDataCellular->other_details) }}</textarea>
