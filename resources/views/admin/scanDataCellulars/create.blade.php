    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.scan-data-cellulars.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="html_changed">{{ trans('cruds.scanDataCellular.fields.html_changed') }}</label>
                    <textarea class="form-control {{ $errors->has('html_changed') ? 'is-invalid' : '' }}" name="html_changed" id="html_changed">{{ old('html_changed') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('package_month_price') ? 'is-invalid' : '' }}" type="number" name="package_month_price" id="package_month_price" value="{{ old('package_month_price', '') }}" step="1">
