    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.scan-data-cellulars.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('package_min_lines') ? 'is-invalid' : '' }}" type="number" name="package_min_lines" id="package_min_lines" value="{{ old('package_min_lines', '1') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minutes_to_other_countries') ? 'is-invalid' : '' }}" type="number" name="minutes_to_other_countries" id="minutes_to_other_countries" value="{{ old('minutes_to_other_countries', '0') }}" step="1">
            ...
            <div class="form-group">
                <label for="other_details">{{ trans('cruds.scanDataCellular.fields.other_details') }}</label>
                <textarea class="form-control {{ $errors->has('other_details') ? 'is-invalid' : '' }}" name="other_details" id="other_details">{{ old('other_details') }}</textarea>
                @if($errors->has('other_details'))
                    <div class="invalid-feedback">
                        {{ $errors->first('other_details') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.scanDataCellular.fields.other_details_helper') }}</span>
            </div>
            <div class="form-group">
